...
import banner from "../../assets/img/contact/contact.png";
      ...
      <div className="relative rounded-[12px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-5">
          ...
          >
            ...
            Whether you are buying, selling, investing, or relocating, our team is here to provide trusted guidance and premium real estate support.
