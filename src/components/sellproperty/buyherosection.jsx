...
import banner from "../../assets/img/sellpropertyimg/Frame 1 (2).png";
      ...
      <div className="relative rounded-[12px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-5">
          ...
          >
           ...
           Connect with Benzies Real Estate to market your property professionally and reach qualified buyers through our trusted international network.
